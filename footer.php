<!-- ======= Footer ======= -->
<footer id="footer" class="footer-layout1 footer-wrapper">


      <div class="footer--patricles">
        <div id="particles-js"></div>
</div>

        <div class="shape-left">
            <img src="assets/img/footer_shape_2.svg" class="img-fluid" alt="image" />
        </div>
    <div class="footer-top " style="background-color: rgba(36, 135, 206, 0.03); ">
        <div class="container">
            <div class="row">

                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>NITTTR EXTENSION CENTRES</h4>
                    <ul>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Bangalore</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Hyderabad</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Kalamassery</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Vijayawada</a></li>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    <h4>OTHER NITTTRS</h4>
                    <ul>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>NITTTR, Chandigarh</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>NITTTR, Kolkata</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>NITTTR, Bhopal</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Tenders</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Phone Book</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Mandatory Disclosure</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Fee Payment</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>REPORT</h4>
                    <ul>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Institute Brochure</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Overseas Training Courses</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>NITTTR Webinar</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Deemed University Report</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>AICTE-EOA Report</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    <h4>CONTACT US</h4>
                    <ul>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>NITTTR Helpdesk</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Your Question</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Maps & Directions</a></li>
                        <li><i class='bx bx-chevron-right'></i> <a href='#'>Campus Tour</a></li>
    ...
    <div class="container py-4">
        <div class="copyright">
            ...
            copyright © 2024,<strong><span> National Institute of Technical Teachers Training and Research
                    Chennai</span></strong>
...
<script type="text/JavaScript">
  ...
  function showSection(sectionId, event) {
    event.preventDefault(); // Prevent default anchor behavior (jump to top)
