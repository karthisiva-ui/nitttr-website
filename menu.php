...
<section class="top-header-section p-0" id="scrollHeader">
    <div id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
            ...
            <i class="bi bi-house  d-flex justify-content-center "></i><a class="nav-link" style="color: white;" href="index.php">Home</a>&nbsp;|&emsp;
            <a class="nav-link" href="rti.php" style="color: white;">RTI</a></i>&nbsp;|&nbsp;
            
            <a class="nav-link" style="color: white;" href="tender.php">Tender</a>&nbsp;|&nbsp;
<i class="bi bi-envelope d-flex justify-content-center"></i><a class="nav-link" style="color: white;" href="contact.php">Contact</a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav mb-2 mb-lg-0 me-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#institute" id="instituteDropdown" role="button"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="instituteDropdown">
                                ...
                                <li><a class="dropdown-item" href="https://www.nitttrc.ac.in/MoA/MoA.html">Memorandum of
                                        Association</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item" href="acadcouncil.php">Academic Council</a></li>
                                ...
                                <li><a class="dropdown-item" href="prevchairmen.php">Previous Chairmen and Directors</a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="administrationDropdown">
                                ...
                                <li class="dropdown"><a href="#"><span>Committees & Incharge</span> <i
                                    ...
                                    <ul>
                                        ...
                                        <li><a class='dropdown-item' href='guesthouse.php'>Guest House & Hotel</a></li>
                                        <li><a class='dropdown-item' href='estate.php'>Estate Officer</a></li>
                                        <li><a class='dropdown-item' href='grievance.php'>Grievance Redressal Committee
                                                - Internal</a></li>
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="academicsDropdown">
                                <li class="dropdown"><a href="#"><span>Departments</span> <i
                                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                                    <ul>
                                        <li><a class='dropdown-item' href='civil.php'>Department Of Civil Engineering
                                        </a>
                                        </li>
                                        <li><a class='dropdown-item' href='computer.php'>Department Of Computer Science And Engineering</a>
                                        </li>
                                        <li><a class='dropdown-item' href='mediatech'>Department Of Educational Media And Technology</a>
                                        </li>
                                        <li><a class='dropdown-item' href='eee.php'>Department Of Electrical And Electronics Engineering</a>
                                        </li>
                                        <li><a class='dropdown-item' href='electronics.php'>Department Of Electronics And Communication Engineering</a>
                                        </li>
                                        <li><a class='dropdown-item' href='mech.php'>Department Of Mechanical Engineering</a>
                                        </li>
                                        <li><a class='dropdown-item' href='education.php'>Department Of Education</a>
                                        </li>
                                        <li><a class='dropdown-item' href='curriculum.php'>Department Of Curriculum Development</a>
                                        </li>
                                        <li><a class='dropdown-item' href='centre_rural.php'>Department Of Rural And Entrepreneurship Development</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown"><a href="#"><span>Centres</span> <i
                                    ...
                                    <ul>
                                        ...
                                        <li><a class='dropdown-item' href='international.php'>International Affairs</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="admissionsDropdown">
                                <li><a class="dropdown-item"
                                        href="https://www.nitttrc.ac.in/admission/index.php">Admission Portal</a></li>
                                <li><a class="dropdown-item"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#information" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">Information Corner</a>
                            <ul class="dropdown-menu" aria-labelledby="informationDropdown">
                                ...
                                <li><a class="dropdown-item" href="https://www.nitttrc.ac.in/cirlogin.php">Circular</a>
                                </li>
                                ...
                                <li><a class="dropdown-item" href="https://www.nitttrc.ac.in/JTVE/index.html">JTVE</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <form class="navbar-form d-flex" role="search" id="srch" action="" method="post"
